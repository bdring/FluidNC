...
struct pin_mux {
    ...
    { 48, "GPIO48", { "SPICLK_N_DIFF", "GPIO48", "SUBSPICLK_N_DIFF", "-", "-" } },
    { -1, "", { "" } },
};
#endif
...
gpio_matrix[] = { {0, "SPIQ_in", "SPIQ_out", true },
                  ...
                  {124, "-", "SUBSPICS0_out", false },
                  {125, "-", "SUBSPICS1_out", false },
                  {126, "-", "FSPIDQS_out", false },
                  ...
                  {153, "-", "LCD_DC", false },
                  {154, "-", "LCD_PCLK", false },
                  {155, "SUBSPID4_in", "SUBSPID4_out", false },
                  {156, "SUBSPID5_in", "SUBSPID5_out", false },
                  {157, "SUBSPID6_in", "SUBSPID6_out", false },
                  {158, "SUBSPID7_in", "SUBSPID7_out", false },
                  {159, "SUBSPIDQS_in", "SUBSPIDQS_out", false },
