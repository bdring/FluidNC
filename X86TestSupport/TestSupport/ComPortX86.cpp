...
ComPortX86::ComPortX86(const char *pPort ) : 
    hSerial(INVALID_HANDLE_VALUE), Channel("com_win32") 
{ 
    DCB dcb;
    BOOL fSuccess;
...
ComPortX86::ComPortX86() : 
    Channel("com_win32"), hSerial(INVALID_HANDLE_VALUE) 
{  }
...
/*
void report_echo_line_received(char* line, Print&) {
    std::cout << "[echo: " << line << "]\n";
}
*/
