...
static void show_setting(const char* name, const char* value, const char* description, Stream& out) {
    out << "$" << name << "=" << value;
    if (description) {
        out << "    " << description;
    }
...
static Error show_help(const char* value, WebUI::AuthenticationLevel auth_level, Stream& out) {
    out << "[HLP:$$ $+ $# $S $L $G $I $N $x=val $Nx=line $J=line $SLP $C $X $H $F $E=err ~ ! ? ctrl-x]\n";
    return Error::Ok;
}

static Error report_gcode(const char* value, WebUI::AuthenticationLevel auth_level, Stream& out) {
    report_gcode_modes(out);
    return Error::Ok;
}

static void show_settings(Stream& out, type_t type) {
    for (Setting* s = Setting::List; s; s = s->next()) {
...
static Error report_normal_settings(const char* value, WebUI::AuthenticationLevel auth_level, Stream& out) {
    show_settings(out, GRBL);  // GRBL non-axis settings
    return Error::Ok;
}
static Error list_grbl_names(const char* value, WebUI::AuthenticationLevel auth_level, Stream& out) {
    for (Setting* s = Setting::List; s; s = s->next()) {
...
static Error list_settings(const char* value, WebUI::AuthenticationLevel auth_level, Stream& out) {
    for (Setting* s = Setting::List; s; s = s->next()) {
...
static Error list_changed_settings(const char* value, WebUI::AuthenticationLevel auth_level, Stream& out) {
    for (Setting* s = Setting::List; s; s = s->next()) {
...
static Error list_commands(const char* value, WebUI::AuthenticationLevel auth_level, Stream& out) {
...
static Error toggle_check_mode(const char* value, WebUI::AuthenticationLevel auth_level, Stream& out) {
...
static Error disable_alarm_lock(const char* value, WebUI::AuthenticationLevel auth_level, Stream& out) {
    if (sys.state == State::ConfigAlarm) {
        return Error::ConfigurationInvalid;
    }
...
static Error report_ngc(const char* value, WebUI::AuthenticationLevel auth_level, Stream& out) {
...
static Error home_all(const char* value, WebUI::AuthenticationLevel auth_level, Stream& out) {
    return home(Machine::Homing::AllCycles);
}
static Error home_x(const char* value, WebUI::AuthenticationLevel auth_level, Stream& out) {
    return home(bitnum_to_mask(X_AXIS));
}
static Error home_y(const char* value, WebUI::AuthenticationLevel auth_level, Stream& out) {
    return home(bitnum_to_mask(Y_AXIS));
}
static Error home_z(const char* value, WebUI::AuthenticationLevel auth_level, Stream& out) {
    return home(bitnum_to_mask(Z_AXIS));
}
static Error home_a(const char* value, WebUI::AuthenticationLevel auth_level, Stream& out) {
    return home(bitnum_to_mask(A_AXIS));
}
static Error home_b(const char* value, WebUI::AuthenticationLevel auth_level, Stream& out) {
    return home(bitnum_to_mask(B_AXIS));
}
static Error home_c(const char* value, WebUI::AuthenticationLevel auth_level, Stream& out) {
    return home(bitnum_to_mask(C_AXIS));
}
static void write_limit_set(uint32_t mask, Stream& out) {
...
static Error show_limits(const char* value, WebUI::AuthenticationLevel auth_level, Stream& out) {
...
static Error go_to_sleep(const char* value, WebUI::AuthenticationLevel auth_level, Stream& out) {
    rtSleep = true;
    return Error::Ok;
}
static Error get_report_build_info(const char* value, WebUI::AuthenticationLevel auth_level, Stream& out) {
    if (!value) {
...
static Error report_startup_lines(const char* value, WebUI::AuthenticationLevel auth_level, Stream& out) {
...
static Error restore_settings(const char* value, WebUI::AuthenticationLevel auth_level, Stream& out) {
    if (!value) {
        return Error::InvalidStatement;
    }
...
static Error showState(const char* value, WebUI::AuthenticationLevel auth_level, Stream& out) {
    const char* name;
...
static Error doJog(const char* value, WebUI::AuthenticationLevel auth_level, Stream& out) {
    if (sys.state == State::ConfigAlarm) {
        return Error::ConfigurationInvalid;
    }
...
static Error listAlarms(const char* value, WebUI::AuthenticationLevel auth_level, Stream& out) {
    if (sys.state == State::ConfigAlarm) {
...
static Error listErrors(const char* value, WebUI::AuthenticationLevel auth_level, Stream& out) {
    if (value) {
        char*   endptr      = NULL;
...
static Error motor_disable(const char* value, WebUI::AuthenticationLevel auth_level, Stream& out) {
    if (sys.state == State::ConfigAlarm) {
        return Error::ConfigurationInvalid;
    }
...
static Error xmodem_receive(const char* value, WebUI::AuthenticationLevel auth_level, Stream& out) {
    if (!value || !*value) {
        value = "uploaded";
    }
    FileStream* outfile;
...
static Error xmodem_send(const char* value, WebUI::AuthenticationLevel auth_level, Stream& out) {
    if (!value || !*value) {
        value = "config.yaml";
    }
    Stream* infile;
...
static Error dump_config(const char* value, WebUI::AuthenticationLevel auth_level, Stream& out) {
    Print* ss;
    try {
        if (value) {
...
static Error fakeLaserMode(const char* value, WebUI::AuthenticationLevel auth_level, Stream& out) {
    if (!value) {
...
Error do_command_or_setting(const char* key, char* value, WebUI::AuthenticationLevel auth_level, Stream& out) {
...
Error settings_execute_line(char* line, Stream& out, WebUI::AuthenticationLevel auth_level) {
