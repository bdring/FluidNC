...
InputFile::InputFile(const char* defaultFs, const char* path, Channel& channel, WebUI::AuthenticationLevel auth_level) :
    FileStream(path, "r", defaultFs), _channel(channel), _auth_level(auth_level), _line_num(0) {}
/*
