...
namespace Kinematics {
    ...
    */
    ...
    bool PolarArm::cartesian_to_motors(float* target, plan_line_data_t* pl_data, float* position) {
        ...
        for (uint32_t segment = 1; segment <= segment_count; segment++) {
            ...
            transform_cartesian_to_motors(seg_positions, motors);
    ...
    */
    ...
    bool PolarArm::canHome(AxisMask axisMask) {
        return true;
    }
    ...
    Kinematic equations
    */
    bool PolarArm::transform_cartesian_to_motors(float* cartesian, float* motors) {
    ...
    float PolarArm::calculate_x_offset(float y_pos) {
        return _arm_length - sqrt((_arm_length * _arm_length) - (y_pos * y_pos));
    }
